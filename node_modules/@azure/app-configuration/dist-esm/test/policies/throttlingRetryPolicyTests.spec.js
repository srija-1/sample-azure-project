...
describe("ThrottlingRetryPolicy", () => {
    ...
    describe("sendRequest", () => {
        it("should clone the request", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield policy.sendRequest(request);
        }));
        it("should not modify the request", () => __awaiter(void 0, void 0, void 0, function* () {
            const request = new WebResource();
            ...
            const response = yield policy.sendRequest(request);
            // requestId is unique, even across retries.
            delete response.request.requestId;
            delete request.requestId;
            chai.assert.deepEqual(response.request, request);
        }));
        it("should do nothing when status code is not 429", () => __awaiter(void 0, void 0, void 0, function* () {
            const request = new WebResource();
            const mockResponse = {
                status: 400,
                headers: new HttpHeaders({
            ...
            yield assertThrowsRestError(() => policy.sendRequest(request), 500, "some other error, but not an 429 with a timeout");
        }));
        it("should pass the response to the handler if the status code equals 429", () => __awaiter(void 0, void 0, void 0, function* () {
            const request = new WebResource();
            const mockResponse = {
                status: 429,
                headers: new HttpHeaders({
